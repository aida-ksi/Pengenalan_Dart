void main() {
  ...
  // Map sama seperti list yaitu sekumpulan data, hanya saja menggunakan kurung kurawal {}
  // dan jika di list menggunakan index, maka di map menggunakan 'key': 'value'
  var mahasiswa1 = {'Nama': 'Azzuhra', 'Usia': 21, 'NIM': '64042xxx'};
